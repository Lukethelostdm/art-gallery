...
export default function Navbar() {
  return (
    <header className="block bg-nav sm:static top-0 z-10">
     ...
     <Image src={wave} alt="nav-wave" className="w-full rotate-180 -z-50 backdrop-blur-sm absolute sm:mt-24 h-max mt-72"/> 
      </div>
      <nav className="flex flex-col gap-4 sm:justify-between items-center p-4 font-bold max-w-full mx-auto uppercase text-text sm:text-lg text-xs font-Anaheim">
